...
use App\Observers\Dashbord\subCagegories;
...
class subcategories extends Model
{
    ...
    public  function mainCat(){
        return $this -> belongsTo('App\Models\Dashbord\mainCategorie' , 'perant_id' ,'id');
    }
    public  function language()
    {
        return $this->belongsTo('App\Models\Dashbord\language', 'lang_id', 'id');
    }
