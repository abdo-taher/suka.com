    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{__('admin/category/add.add-cat')}}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('Dashbord')}}">Home</a></li>
                            <li class="breadcrumb-item active">{{__('admin/category/add.main_categories')}}</li>
                        </ol>
                    </div>
            ...
            <form method="POST" action="">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="exampleInputEmail1" placeholder="{{__('admin/category/add.slug_ph')}}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card card-default">
                                <div class="card-header">
                                    <h3 class="card-title">{{$lang = $properties['native'] == 'English'
                                                ? __('admin/category/add.en') : __('admin/category/add.ar') }}</h3>
